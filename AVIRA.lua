...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Messi100/vvvvvv/main/File_Bot/commands.lua") 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ويستون'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "DAD_MESSIFOA")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ¹𝚆𝙴𝚂𝚃𝙾𝙽¹")  
...
Namebot = (database:get(bot_id..'Name:Bot') or 'ويستون')
...
{{text = '𝘾𝙃𝘼𝙉𝙉𝙀𝙇', url="t.me/DAD_MESSIFOA"}},
} 
local Keyboard = {
{'𓆩| ıl`W E S T O N´lı |𓆪'},
{'نسبه الكره','نسبه الرجوله'},
{'نسبه الحب','نسبه الانوثه'},
{'𓆩| ıl`W E S T O N´lı |𓆪'},
{'ايدي','العاب ويستون','سورس','تغير الايدي'},
{'𓆩| ıl`W E S T O N´lı |𓆪'},
...
os.execute('wget https://raw.githubusercontent.com/Messi100/vvvvvv/main/AVIRA.lua')
send(msg.chat_id_, msg.id_,'◉ تم تحديث السورس')
dofile('AVIRA.lua')  
end
if text == 'الاصدار ' and sudo2(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس ويستون { s: 6.7}')
end
if text == 'ديفيد مبرمج السورس' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV Messi](t.me/DAD_MESSI)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽M E S S I₎ ✤ ', url="t.me/DAD_MESSI"}}, 
} 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/DAD_MESSIFOA)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/DAD_MESSIFOA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if AddChannel(msg.sender_user_id_) == false then
local DAD_MESSIFOA = database:get(bot_id..'text:ch:user')
if DAD_MESSIFOA then
send(msg.chat_id_, msg.id_,'['..DAD_MESSIFOA..']')
else
...
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'DAD_MESSIFOA')..')'
status  = '\n ◉ تم ترقيته مطور'
...
usertext = '\n ◉ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DAD_MESSIFOA')..')'
status  = '\n ◉ تم ترقيته مطور'
...
if AVIRA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DAD_MESSIFOA')..') \n ◉ '..AVIRA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/DAD_MESSIFOA)}\n ◉ ["..AVIRA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◉ عذرا ← {["..data.first_name_.."](T.ME/DAD_MESSIFOA)}\n ◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf AVIRA.lua')
os.execute('wget https://raw.githubusercontent.com/Messi100/vvvvvv/main/AVIRA.lua')
os.execute('wget https://raw.githubusercontent.com/Messi100/vvvvvv/main/library')
os.execute('wget https://raw.githubusercontent.com/Messi100/vvvvvv/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('AVIRA.lua')  
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹E L G O K I R¹˼ 𓌺 ',url="t.me/ABNALSAIED"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ABNALSAIED&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ ᴍᴇssɪ 𖣌 ',url="t.me/DAD_MESSI"},{text = ' ◍ ʙᴀʀᴀᴢᴇʟɪʏ 𖣌 ',url="t.me/BarazeilyElfRunsi"}},
{{text = '  ◍ ᴇʟɢᴏᴋɪʀ 𖣌 ', url="t.me/ABNALSAIED"}},
{{text = '   ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌  ', url="t.me/DAD_MESSIFOA"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/DAD_MESSIFOA/522&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = '𖣘⁽E L G O K I R ₎𖣘', url="http://t.me/ABNALSAIED"}},
{{text = '  𖣘 ⁽M E S S I₎ 𖣘 ',url="t.me/DAD_MESSI"}},
{{text = '  𖣘 ⁽E L B A R A Z Y I L Y₎ 𖣘 ',url="t.me/BarazeilyElfRunsi"}}
}
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
local Text = [[
 ◉ اهلا بك في سورس ويستون الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ◉ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽M E S S I₎ 𖣘 ',url="t.me/DAD_MESSI"}},
{{text = '  𖣘 ⁽E L G O K I R₎ 𖣘 ',url="t.me/ABNALSAIED"}},
{{text = '𖣘⁽E L B A R A Z I L Y₎𖣘', url="http://t.me/BarazeilyElfRunsi"}},
{{text = '  ❨ TＷＡＳＯＬ ◉  ❩ ',url="t.me/Dadmessibot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ويستون ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ويستون ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/DAD_MESSIFOA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '⩹━━━━⊶❲¹𝚆𝙴𝚂𝚃𝙾𝙽¹❳⊷━━━━⩺' then
local Text = [[ 
◉من أحسن السورسات على التليجرام سورس ويستون◉
...
◉ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [W E S T O N](t.me/DAD_MESSIFOA) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب ويستون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◉ اهلا في قائمه الالعاب المتطوره سورس ويستون  ◉ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DAD_MESSIFOA')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DAD_MESSIFOA')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DAD_MESSIFOA')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if result.id_ == tonumber(2044845458) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(2145896514) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(2027691912) then
...
if tonumber(userid) == tonumber(2044845458) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(2145896514) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج باور عام")
return false 
end
if tonumber(userid) == tonumber(2027691912) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(2044845458) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع كتم مبرمج ميسي عام")
return false 
end
if tonumber(userid) == tonumber(2145896514) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع كتم مبرمج السورس عام")
...
if sudo2(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Messi100/vvvvvv/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات ويستون\n ◉ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n⩹━━━━⊶❲¹𝚆𝙴𝚂𝚃𝙾𝙽¹❳⊷━━━━⩺\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { ✖ } ملف معطل\n ◉ قناة سورس ويستون ↓\n".." ◉ [اضغط هنا لدخول](t.me/DAD_MESSIFOA) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Messi100/vvvvvv/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('AVIRA.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس ويستون \n") 
end
return false
end
...
if text == ("مسح قائمه ويستون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه ويستون')
return false
end

if text == 'قائمه ويستون' and Sudo(msg) then
...
if text == ("رفع ويستون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local DAD_MESSIFOA = database:get(bot_id..'text:ch:user')
if DAD_MESSIFOA then
send(msg.chat_id_, msg.id_,'['..DAD_MESSIFOA..']')
...
if text and text:match("^رفع ويستون @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ويستون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local DAD_MESSIFOA = database:get(bot_id..'text:ch:user')
if DAD_MESSIFOA then
send(msg.chat_id_, msg.id_,'['..DAD_MESSIFOA..']')
...
if text and text:match("^رفع ويستون (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ويستون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local DAD_MESSIFOA = database:get(bot_id..'text:ch:user')
if DAD_MESSIFOA then
send(msg.chat_id_, msg.id_,'['..DAD_MESSIFOA..']')
...
if text == ("تنزيل ويستون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local DAD_MESSIFOA = database:get(bot_id..'text:ch:user')
if DAD_MESSIFOA then
send(msg.chat_id_, msg.id_,'['..DAD_MESSIFOA..']')
...
if text and text:match("^تنزيل ويستون @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ويستون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local DAD_MESSIFOA = database:get(bot_id..'text:ch:user')
if DAD_MESSIFOA then
send(msg.chat_id_, msg.id_,'['..DAD_MESSIFOA..']')
...
if text and text:match("^تنزيل ويستون (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ويستون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local DAD_MESSIFOA = database:get(bot_id..'text:ch:user')
if DAD_MESSIFOA then
send(msg.chat_id_, msg.id_,'['..DAD_MESSIFOA..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DAD_MESSIFOA')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◉ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DAD_MESSIFOA')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'DAD_MESSIFOA')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '¹𝚆𝙴𝚂𝚃𝙾𝙽¹.',url="t.me/DAD_MESSIFOA"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."DAD_MESSIFOA:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."DAD_MESSIFOA:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."DAD_MESSIFOA:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."DAD_MESSIFOA:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."DAD_MESSIFOA:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."DAD_MESSIFOA:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ويستون يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ويستون').." غادر" or text == 'غادر' then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ويستون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ويستون')
local AVIRA_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'DAD_MESSIFOA')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙸𝚁𝙰', url="t.me/DAD_MESSIFOA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = '  ✤ ⁽SＯＵＲＣＥ₎ ✤', url="t.me/DAD_MESSIFOA"}},
{{text = 'BACK◉ ', callback_data="/add"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ويستون')
